...
-- CreateEnum
CREATE TYPE "AccountProvider" AS ENUM ('GITUB');
...
CREATE TABLE "projetcts" (
    ...
    CONSTRAINT "projetcts_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "projetcts_slug_key" ON "projetcts"("slug");
...
-- AddForeignKey
ALTER TABLE "projetcts" ADD CONSTRAINT "projetcts_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "organizations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "projetcts" ADD CONSTRAINT "projetcts_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
